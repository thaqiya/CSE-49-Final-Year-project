...
router.get("/api/location/nearby-relief-camps", async (req, res) => {
  ...
  const query = `
    [out:json];
    (
      node["amenity"="hospital"](around:5001, ${lat}, ${lng});
      node["amenity"="police"](around:5001, ${lat}, ${lng});
      node["amenity"="disaster_relieving"](around:5001, ${lat}, ${lng});
      node["amenity"="ngo"](around:5001, ${lat}, ${lng});
    );
    out body;
  `;
